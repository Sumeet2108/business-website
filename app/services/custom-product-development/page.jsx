      ...
      <div className="flex flex-row bg-black gap-0 md:gap-2 ">
        <div className=" w-1/2  flex flex-col items-start justify-center ml-5 md:ml-10  h-96 md:h-[50vh]">
          ...
          <p className="text-base  sm:text-xl  text-gray-300 ">
            These services are tailored to help you develop high-quality,
            cost-effective parts that are optimized for injection moulding from
            the outset.
          </p>
        </div>
      ...
      <div className=" flex items-start justify-start max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-10 ">
        <ul className="space-y-6 text-left max-w-3xl mx-auto text-black">
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Concept-to-Production Guidance:</strong>
            <br />
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Material & Process Selection:</strong>
            <br />
            <span className="text-base  md:text-lg">
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Design for Manufacturability (DFM):</strong>
            <br />
            <span className="text-base  md:text-lg">
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Prototype Development & Testing:</strong>
            <br />
            <span className="text-base  md:text-lg ">
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Cost Optimization Strategies:</strong>
            <br />
            <span className="text-base  md:text-lg">
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Advanced Simulation & Analysis</strong>
            <br />
            <span className="text-base  md:text-lg">
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Iterative Design Support:</strong>
            <br />
            <span className="text-base  md:text-lg">
          ...
          <li className="text-lg sm:text-xl  cursor-default">
            <strong className="">Compliance & Standards Adherence:</strong>
            <br />
            <span className="text-base  md:text-lg">
